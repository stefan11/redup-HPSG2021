...
\ea\label{ex:nonvol}
\ea
\gll keshi xian mujin, dajia ye zhihao \textbf{weiqu-weiqu} le.\\
...
\ea
  ...
  \gll wujian gong-xiu mo dian bohe-gao huo \textbf{jiao}-\textbf{jiao} kouxiangtang.\\
   ...
   \gll Songailing \textbf{kan}-\textbf{le}-\textbf{kan} yupen you zou-le chulai.\\
   Songailing look-\textsc{pfv}-look bath.tub again walk-\textsc{pfv} out\\  \jambox{(CCL)}
   \glt `Songailing looked at the bath tub a little bit and walked out again.'
   \z
\z
...
\footnotetext[13]{Rou, Shi. 1975. \emph{Roushi xiaoshuo xuanji [Selected novels of Roushi]}, 31. Beijing: People's Literature Publishing House.}
\footnotetext[14]{Li, Jieren. 1962. \emph{Da bo [Great wave]}, 3rd band, 171. Beijing: The Writers Publishing House.}
\ea
 ...
 \gll er di-tou xiang jiang-xin yi kan, jiduo sanluan-zhe de chuan li de dengguang, ye huyinhumie de \textbf{bianhuan-le-yi-bianhuan} weizhi.\\
  and bow-head towards river-middle one look many scattered-\textsc{dur} \textsc{de} boat in \textsc{de} light also flicker \textsc{de} change-\textsc{pfv}-one-chang position\\ \jambox{(CCL)}
...
\added{The analysis is implemented as part of the CoreGram project \citep{MuellerCoreGram} in a Cinese
