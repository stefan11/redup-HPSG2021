...
As illustrated in (\ref{ex:redup-forms}) in Section~\ref{ch:intro}, the reduplication can only be separated by \emph{le} and \emph{yi}, but the word status of these elements cannot be easily defined.
...
and the list containing the \type{deliminitive-rel}. In addition to the inherited constraints,
