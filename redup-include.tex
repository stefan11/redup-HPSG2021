...
\begin{itemize}[<+->]
    ...
    \end{itemize}
    \item Special structure for reduplication \citep{FanSongBond2015, Ghomeshietal2004, Travis2001, Travis2003}
    \begin{itemize}
        \item[+] No problem with A-\emph{yi}-A
        \item[$-$] Connection with aspect markers not captured
    \end{itemize}
\end{itemize}
}
...
\begin{itemize}[<+->]
    ...
    \item Different forms of reduplication are captured in a type hierarchy using underspecified phonological lists.
