...
\ea \gll for disyllabic verbs: \emph{lai-wang} `come and go/communicate'\\
	{} {} {} come-go\\
...
\ea
  \ea\label{ex:guo-dyn}
    ...
    he serve.as-\textsc{exp} solider\\
    \glt `He once served as a solider.'
  \ex\label{ex:le-dyn}
    \gll ta dang-le bing.\\
    he serve.as-\textsc{pfv} soldier\\
    \glt `He became a solider.'
  \ex
...
rels & <[\type*{perfective-rel}\\
       arg & \3]>
       $\oplus$ \2 $\oplus$
        <[\type*{delimitative-rel}\smallskip\\                 arg & \3]>\\
lex-dtr & [phon & \1\\
	\punk{synsem|loc}{[cat|head & verb\\
                      cont|ind & \3]}\\
    rels & \2]
