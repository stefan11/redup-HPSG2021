...
\frame{
\frametitle{Verbal reduplication lexical rule: A-\emph{yi}-A-lr}
...
\frame{
\frametitle{Perfective lexical rule: V-\emph{le}-lr}
...
\frame{
\frametitle{A-\emph{le}-\emph{yi}-A-lr, A-\emph{le}-A-lr}
